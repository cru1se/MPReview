...
-(void)setBoundsX:(CGFloat)boundsX{
    [self setBounds:CGRectMake(boundsX, self.boundsMinY,self.boundsWidth, self.boundsHeight)];
}

-(void)setBoundsY:(CGFloat)boundsY{
    [self setBounds:CGRectMake(self.boundsMinX, boundsY, self.boundsWidth, self.boundsHeight)];
}
